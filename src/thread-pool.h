...
struct tp_work_s{
	...
	void (*process_job)(tp_work *this_, tp_work_desc *job);
};
...
struct tp_thread_pool_s{
	TPBOOL (*init)(tp_thread_pool *this_);
	void (*close)(tp_thread_pool *this_);
	void (*process_job)(tp_thread_pool *this_, tp_work *worker, tp_work_desc *job);
	int  (*get_thread_by_id)(tp_thread_pool *this_, int id);
	TPBOOL (*add_thread)(tp_thread_pool *this_);
	TPBOOL (*delete_thread)(tp_thread_pool *this_);
	int (*get_tp_status)(tp_thread_pool *this_);
